  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <section id="home" className="py-16 px-6 text-center bg-gradient-to-br from-blue-100 to-purple-100">
        ...
        <a href="#" className="inline-block bg-black text-white px-6 py-2 rounded-full">Shop on TikTok</a>
      </section>
      ...
      <section id="shop" className="py-12 px-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        <div className="border rounded-xl p-4 hover:shadow-lg transition-shadow">
          <img src="https://ae01.alicdn.com/kf/S0b9e5bc3395f48bcb51e6cf5e3e76e0bb.jpg" alt="Squishy Cube" className="mb-4 w-full h-48 object-cover rounded-xl" />
          ...
          <p className="mb-4 text-sm text-gray-600">Unwind instantly with this super-soft Squishy Cube — a satisfying, palm-sized stress reliever designed to melt tension away. Made from ultra-squishy, slow-rising foam, it’s perfect for squeezing, squashing, and fidgeting during work, study, or downtime.</p>
          <a href="#" className="inline-block bg-black text-white px-4 py-2 rounded-full">Buy on TikTok</a>
        </div>
        <div className="border rounded-xl p-4 hover:shadow-lg transition-shadow">
          <img src="https://ae01.alicdn.com/kf/S1400fbc7549e400e9d18e7a1638182c5I.jpg" alt="Squishy Cube 2" className="mb-4 w-full h-48 object-cover rounded-xl" />
          <h3 className="text-xl font-semibold mb-2">Squishy Cube Stress Relief Toy #2</h3>
          <p className="text-sm text-gray-700 mb-2 font-medium">£4.50 + £3.99 delivery</p>
          <p className="mb-4 text-sm text-gray-600">A colorful, ultra-squishy stress cube that’s great for relaxing, focusing, and sensory fun. Soft and slow-rising with a smooth foam feel.</p>
          <a href="#" className="inline-block bg-black text-white px-4 py-2 rounded-full">Buy on TikTok</a>
        </div>
        <div className="border rounded-xl p-4 hover:shadow-lg transition-shadow">
          <img src="https://ae01.alicdn.com/kf/Sb4ef27c3d0a54ef5b91f9499117290bdX.jpg" alt="Squishy Cube 3" className="mb-4 w-full h-48 object-cover rounded-xl" />
          <h3 className="text-xl font-semibold mb-2">Squishy Cube Stress Relief Toy #3</h3>
          <p className="text-sm text-gray-700 mb-2 font-medium">£4.50 + £3.99 delivery</p>
          <p className="mb-4 text-sm text-gray-600">Soft, colorful, and satisfying to squeeze — this stress cube is perfect for both kids and adults who love tactile stimulation.</p>
          <a href="#" className="inline-block bg-black text-white px-4 py-2 rounded-full">Buy on TikTok</a>
        </div>
      </section>
